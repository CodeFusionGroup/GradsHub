...
public class PostsListRecyclerViewAdapter extends RecyclerView.Adapter<PostsListRecyclerViewAdapter.ViewHolder>{// implements Filterable {
    ...
    public PostsListRecyclerViewAdapter(List<Post> items, OnPostsListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
