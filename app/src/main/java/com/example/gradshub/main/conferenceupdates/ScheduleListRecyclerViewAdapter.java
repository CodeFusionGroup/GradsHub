...
import com.example.gradshub.main.availablegroups.AvailableGroupsListFragment.OnAvailableGroupsListFragmentInteractionListener;
...
public class ScheduleListRecyclerViewAdapter extends RecyclerView.Adapter<ScheduleListRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    public ScheduleListRecyclerViewAdapter(List<ResearchGroup> items, OnAvailableGroupsListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
